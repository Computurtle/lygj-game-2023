...
namespace Febucci.UI.Core
{
    ...
    public static class TAnimBuilder
    {
        ...
        public static void InitializeGlobalDatabase()
        {
            ...
            {
                Debug.LogWarning($"TextAnimator: Global database not found. Please ensure that the file '{TAnimGlobalDataScriptable.resourcesPath}' exists in the Resources folder.");
            }
